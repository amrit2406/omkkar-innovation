...
const benefits = [
  {
    icon: <UserCheck />,
    text: "Expert-led sessions with real-world case studies",
  },
  { icon: <Globe />, text: "Flexible online & offline learning options" },
  {
    icon: <Layers />,
    text: "Access to exclusive learning resources and a supportive community",
  },
  {
    icon: <Award />,
    text: "Internationally recognized certification upon completion",
  },
];
...
const Training = () => {
  ...
  const renderProgramSection = (title, programs) => (
    <div className="space-y-24 py-20 md:py-32 relative z-10">
      <h2 className="text-4xl md:text-5xl font-extrabold text-[#653781] mb-12 text-center">
        {title}
      </h2>
          ...
          >
            ...
            <div className="space-y-3 text-gray-700">
              <p className="font-semibold text-lg flex items-center gap-2">
                <Calendar className="w-5 h-5 text-[#b0436d]" /> Duration:{" "}
                {program.duration}
              </p>
    ...
    <main className="bg-gray-50 text-gray-800 relative overflow-hidden">
      ...
      <section className="relative h-96 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          >
            Our training programs are designed to equip you with the skills and
            knowledge that today’s competitive markets demand.
          </motion.p>
        </div>
      </section>
      ...
      >
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=1770&auto=format&fit=crop"
            alt="About Our Training Approach"
            className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#653781]/40 via-transparent to-transparent opacity-70 group-hover:opacity-100 transition-opacity duration-300" />
        </motion.div>
        <motion.div className="space-y-6" variants={itemVariants}>
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#653781] leading-tight">
            Our Training Approach: Practical & Results-Driven
          </h2>
          <p className="text-gray-700 leading-relaxed text-lg">
            We believe that the best way to learn is by **doing**. Our training programs are built around hands-on projects, real-world case studies, and live, interactive sessions. We focus on practical application over abstract theory, ensuring you can immediately apply your new skills.
          </p>
          <p className="text-gray-700 leading-relaxed text-lg">
            Our expert instructors bring years of industry experience to the classroom, offering personalized mentorship and guidance. Whether you're a beginner or an experienced professional, our courses are designed to help you master new skills and accelerate your career.
          </p>
        </motion.div>
      </motion.section>
      ...
      {renderProgramSection(
        ...
        trainingPrograms.technical
      )}

      {/* Non-Technical Training */}
      {renderProgramSection(
        "Non-Technical Training Programs",
        trainingPrograms.nonTechnical
      )}
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8 md:p-10 relative"
            >
              {/* Close button */}
              <button
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#653781] mb-6">
                Enroll Now
              </h2>
              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  // optionally, you can handle form data here
                }}
              >
                <input
                  type="text"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#653781] to-[#b0436d] text-white font-semibold py-3 rounded-xl shadow hover:scale-105 transition-transform"
                >
                  Submit
                </button>
              </form>
